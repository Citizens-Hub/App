...
const SHIP_FOCUS_TRANSLATIONS: ShipMetadataTranslationMap = {
  ...
  'heavy dropship': { 'zh-CN': '重型登陆艇', 'zh-HK': '重型登陸艇', en: 'Heavy Dropship', 'ja-JP': '大型降下艇', 'de-DE': 'Schweres Landungsschiff' },
  ...
  'light refueler': { 'zh-CN': '轻型加油', 'zh-HK': '輕型加油', en: 'Light Refueler', 'ja-JP': '軽補給', 'de-DE': 'Leichte Betankung' },
  'heavy refueling': { 'zh-CN': '重型加油', 'zh-HK': '重型加油', en: 'Heavy Refueler', 'ja-JP': '重補給', 'de-DE': 'Schwere Betankung' },
