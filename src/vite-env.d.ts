...
interface ImportMetaEnv {
  ...
  readonly VITE_PUBLIC_GOOGLE_ADS_SIGNUP_SEND_TO?: string;
  readonly VITE_PUBLIC_GOOGLE_ADS_ADD_TO_CART_SEND_TO?: string;
  readonly VITE_PUBLIC_GOOGLE_ADS_BEGIN_CHECKOUT_SEND_TO?: string;
  readonly VITE_PUBLIC_GOOGLE_ADS_PURCHASE_SEND_TO?: string;
}
