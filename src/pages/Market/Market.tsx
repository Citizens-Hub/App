...
const MarketCcuRoutePlanner = React.memo(function MarketCcuRoutePlanner({
  ...
  const buildPlannerAnalyticsPayload = useCallback((options?: {
    ...
    return {
      ...
      startShipId: plannerStartShip?.id ?? null,
      startShipName: plannerStartShip?.name ?? null,
      targetShipId: plannerTargetShip?.id ?? null,
      targetShipName: plannerTargetShip?.name ?? null,
      ...
      validRoute: options?.routeFound ?? Boolean(route),
